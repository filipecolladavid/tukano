...
import test.tukano.clients.rest.RestBlobsClient;
import test.tukano.clients.rest.RestShortsClient;
import test.tukano.clients.rest.RestUsersClient;
...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        var serverURI = "http://192.168.49.2:31789/rest"; // Use the current Minikube service URL
